...
11. По окончании настройки пользователей введите `closessh` для закрытия всех портов, кроме 443/TCP ✨ Доступ к VPS будет только из консоли хостера в Панели Управления VPS.
