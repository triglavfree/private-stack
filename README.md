...
2. Установите образ Ubuntu 24.04.
3. Сгенерируйте новый пароль на сервере в Панели управления и скопируйте его в буфер обмена.
> Для подключения к серверу другими способами: Сгенерируйте SSH ключи на своём устройстве и пропишите PUB ключ в Панели Управления VPS. 🚫 Не рекомендую это делать, так как **это скомпроментирует Вас** и сервер. 
...
4. Вставьте скопированную ссылку для запуска скрипта и Нажмите `Enter`  в консоль сервера.
