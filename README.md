...
- **Perplexica** — AI-поиск с поддержкой Groq, OpenAI, Wolfram Alpha
- **SearXNG** — анонимный метапоисковик (встроен в Perplexica)
- **Весь трафик через Xray** — маскировка IP при поиске и запросах к LLM
- **Нет Docker, нет панелей, нет избыточности**
