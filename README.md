...
2. Установите образ Ubuntu 24.04 на VPS. Используйте [браузер](https://github.com/TheTorProject) [TOR browser](https://www.torproject.org/download/) для конфеденциальности подключения к Панели управления VPS и сайту хостера.
