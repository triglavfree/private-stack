...
>- Профиль **iosuser** скрнструирован под [платное](https://apps.apple.com/ru/app/shadowrocket/id932747118) приложение [SHADOWROCKET](https://shadowrocketvpn.com/) так как использует встроенную **TLS библиотеку Apple**. Это **фундаментальный компонент**, который превращает связку **VLESS + REALITY + Vision** из набора протоколов в мощный, целостный инструмент для обхода цензуры, обеспечивающий **Высочайший уровень скрытности и производительности** на мобильных устройствах! но и в остальных клиентах на **ios** работает Великолепно.
