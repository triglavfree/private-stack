...
4. Сгенерируйте SSH ключи на своём устройстве и пропишите PUB ключ в Панели Управления VPS если необходимо подключение к серверу. 🚫 Не рекомендую это делать, так как **это скомпроментирует Вас** и сервер. 
...
8. Нажмите Подключить (в клиенте долно быть всё понятно интуитивно).
...
10. Настройте пользователей и получите для нихссылки: Три вида профилей пользователей: **Android** - Chrome fingerprint + Google маскировка; **Стандартный** - Firefox fingerprint + Cloudflare маскировка; **Кастомный** - Ручной ввод SNI и fingerprint.
