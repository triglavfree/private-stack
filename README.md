...
> Сгенерируйте SSH ключи на своём устройстве и пропишите PUB ключ в Панели Управления VPS. 🚫 Не рекомендую подключаться с VPS по внешнему IP, так как **это скомпроментирует Вас** и сервер. 
...
>
> **Владельцам IPHONE**: в консоли сервера введите команду `iosuser` и отсканировать QR код.
...
> Три вида профилей пользователей: **Android** - Chrome fingerprint + Google маскировка; **Стандартный** - Firefox fingerprint + Cloudflare маскировка; **Кастомный** - Ручной ввод SNI и fingerprint.
