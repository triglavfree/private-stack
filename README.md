...
4. Сгенерируйте SSH ключи на своём устройстве и пропишите PUB в Панели Управления VPS если необходимо подключение к серверу. 🚫Не рекомендую это делать, так как это скомпроментирует сервер.
